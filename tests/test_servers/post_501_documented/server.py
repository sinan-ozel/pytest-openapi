"""Mock server - POST endpoint returning 501 with it being documented."""
...
def openapi():
    """OpenAPI spec expecting 200 response, and 501 IS documented."""
    return jsonify(
        {
            "openapi": "3.0.0",
            "info": {"title": "POST 501 Documented API", "version": "1.0.0"},
            "paths": {
                "/generate": {
                    "post": {
